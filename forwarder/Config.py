...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "5457862323:AAEWcjABMlcvzUG-JgU9wiwEajVWXLUEpbU"  # API key obtained from BotFather
    OWNER_ID = "2056407064"  # If you dont know, run the bot and do /id in your private chat with the bot

    # FOR AUTOMATICALLY FORWARDING MESSAGES
    FROM_CHATS = [-1001667023505]  # List of chat id's to forward messages from
    TO_CHATS = [-1001772207087]  # List of chat id's to forward messages to
